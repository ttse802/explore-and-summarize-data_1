...
ggplot(data = wine, aes(x=fixed.acidity, y=pH))+
  geom_jitter(alpha = 0.6, aes(color = quality)) +
  scale_color_continuous(name="Quality") +
...
- The box-plot confirms the quality distribution previously that most red wine are between 4 to 7 with 5 and 6 being the most popular.
